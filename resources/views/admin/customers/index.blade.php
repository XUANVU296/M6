            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="panel-heading">
                            <h2 class="offset-4">Danh Sách Khách Hàng</h2>
                        </div>
                        ...
                        <form action="{{ route('customers.index') }}" method="GET" id="form-search" class="d-flex">
                            <div class="col">
                                <input name="search_name" class="form-control" type="text" placeholder="Tìm tên" value="{{ request('search_name') }}" />
                            </div>
                            <div class="col">
                                <input name="search_email" class="form-control" type="text" placeholder="Tìm email" value="{{ request('search_email') }}" />
                            </div>
                            <div class="col">
                                <input name="search_phone" class="form-control" type="text" placeholder="Tìm SĐT" value="{{ request('search_phone') }}" />
                            </div>
                            <div class="col">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('customers.edit', $customer->id) }}"><i class="bx bx-edit-alt me-1"></i> Sửa</a>
