                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                                            ...
                                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                                ...
                                                                <label class="form-check form-switch ">
                                                                    <input type="checkbox" @checked(in_array($role['id'], $userRoles))
                                                                     name="roles[]" class="checkItem form-check-input checkItem"
                                                                     value="{{ $role['id'] }}">
                                            ...
                                            <div class="form-actions">
                                                <button class="btn btn-secondary me-2" type="submit">Duyệt</button>
                                                <a href="{{ route('groups.index') }}" class="btn btn-danger" type="submit">Hủy</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
